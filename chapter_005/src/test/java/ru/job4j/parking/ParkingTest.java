...
public class ParkingTest {
    ...
    public void createPassengerLots() {
        for (int i = 0; i < 10; i++) {
            passengerLots.add(new Lot(true, 1));
            mixedLots.add(new Lot(true, 2));
        }
    }
    ...
    public void parkTruckToPassengerParkingTest() {
        for (int i = 0; i < 5; i++) {
            passengerLots.get(i).parkCar(new Truck(2));
        }
    }

    @Test(expected = RuntimeException.class)
    public void parkCarOnUnAvailablePlace() {
        mixedLots.get(0).parkCar(new Truck(2));
    ...
    public void availableLotTest() {
        ...
        for (int i = 0; i < 3; i++) {
            parking.getPlaces(0).getLot(i).parkCar(new Truck(2));
        }
